...
{
  try{
     var cont = mywidgEditor.theIframe.contentWindow.document.getElementsByTagName("body")[0].innerHTML;
   }catch(e){ var cont = ''  }

   if(cont.length > 0) {
     mywidgEditor.writeDocument(cont + "    " + text);
   }else{
     mywidgEditor.writeDocument(text);
   }
}
