   ...
   function chart(nextAppointmentDate) {
    ...
    while (number < 13) {
      ...
      while (startDate <= endDate) { 
        ...
        chart+="\n<tr>"
        chart+= '\n<td onclick="addDate(\''+sunday_str+'\');" class="dates" id="'+sunday_str+'">' +sunday+ "</td>";
        chart+= '\n<td onclick="addDate(\''+monday_str+'\');" class="dates" id="'+monday_str+'">' +monday+ "</td>";
        chart+= '\n<td onclick="addDate(\''+tuesday_str+'\');" class="dates" id="'+tuesday_str+'">' +tuesday+ "</td>";
        chart+= '\n<td onclick="addDate(\''+wednesday_str+'\');" class="dates" id="'+wednesday_str+'">' +wednesday+ "</td>";
        chart+= '\n<td onclick="addDate(\''+thursday_str+'\');" class="dates" id="'+thursday_str+'">' +thursday+ "</td>";
        chart+= '\n<td onclick="addDate(\''+friday_str+'\');" class="dates" id="'+friday_str+'">' +friday+ "</td>";
        chart+= '\n<td onclick="addDate(\''+saturday_str+'\');" class="dates" id="'+saturday_str+'">' +saturday+ "</td>";
        chart+="\n</tr>"
